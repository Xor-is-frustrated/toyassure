package com.increff.channel.pdf;
...
public class PDFFromFOP {
	...
	public static void generatePDF(Long id) {
		try {
			...
			File xsltfile = new File("src\\main\\resources\\com\\increff\\channel\\style.xsl");
			File pdfDir = new File("./src/main/resources/com/increff/channel");
			pdfDir.mkdirs();
	...
	public static void generateResponse(HttpServletResponse response) throws IOException {
		...
		File pdfFile = new File("src\\main\\resources\\com\\increff\\channel\\invoice.pdf");
