...
public class InventoryService extends AbstractService {
	...
	public InventoryPojo add(InventoryPojo p) throws ApiException {
		...
		Long fulfilledQuantity = p.getAllocatedQuantity();
		checkPositive(fulfilledQuantity, " Available quantity cannot be less than zero");
		Long availableQuantity = p.getAllocatedQuantity();
		checkPositive(availableQuantity, "Fulfilled quantity cannot be less than zero");
